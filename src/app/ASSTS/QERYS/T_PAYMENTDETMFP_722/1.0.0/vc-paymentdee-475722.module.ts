...
import { VcPaymentdee475722Component } from './vc-paymentdee-475722.component';


@NgModule({
  declarations: [
    VcPaymentdee475722Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentdee475722Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentdee475722Component],
  providers: [
    {
...
export class VcPaymentdee475722Module { }