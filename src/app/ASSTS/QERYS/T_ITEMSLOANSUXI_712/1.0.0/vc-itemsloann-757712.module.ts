...
import { VcItemsloann757712Component } from './vc-itemsloann-757712.component';


@NgModule({
  declarations: [
    VcItemsloann757712Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcItemsloann757712Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcItemsloann757712Component],
  providers: [
    {
...
export class VcItemsloann757712Module { }