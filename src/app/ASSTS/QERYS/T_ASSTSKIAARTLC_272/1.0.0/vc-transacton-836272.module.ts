...
import { VcTransacton836272Component } from './vc-transacton-836272.component';


@NgModule({
  declarations: [
    VcTransacton836272Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcTransacton836272Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcTransacton836272Component],
  providers: [
    {
...
export class VcTransacton836272Module { }