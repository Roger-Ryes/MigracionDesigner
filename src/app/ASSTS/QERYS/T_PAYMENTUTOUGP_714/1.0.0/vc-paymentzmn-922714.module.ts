...
import { VcPaymentzmn922714Component } from './vc-paymentzmn-922714.component';


@NgModule({
  declarations: [
    VcPaymentzmn922714Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentzmn922714Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentzmn922714Component],
  providers: [
    {
...
export class VcPaymentzmn922714Module { }