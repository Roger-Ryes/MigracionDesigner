...
import { VcLoantrancl595995Component } from './vc-loantrancl-595995.component';


@NgModule({
  declarations: [
    VcLoantrancl595995Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoantrancl595995Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoantrancl595995Component],
  providers: [
    {
...
export class VcLoantrancl595995Module { }