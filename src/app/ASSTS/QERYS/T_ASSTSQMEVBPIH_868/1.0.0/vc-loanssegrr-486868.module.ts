...
import { VcLoanssegrr486868Component } from './vc-loanssegrr-486868.component';


@NgModule({
  declarations: [
    VcLoanssegrr486868Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanssegrr486868Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanssegrr486868Component],
  providers: [
    {
...
export class VcLoanssegrr486868Module { }