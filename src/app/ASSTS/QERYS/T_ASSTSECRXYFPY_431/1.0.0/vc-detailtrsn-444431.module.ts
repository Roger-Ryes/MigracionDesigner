...
import { VcDetailtrsn444431Component } from './vc-detailtrsn-444431.component';


@NgModule({
  declarations: [
    VcDetailtrsn444431Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcDetailtrsn444431Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcDetailtrsn444431Component],
  providers: [
    {
...
export class VcDetailtrsn444431Module { }