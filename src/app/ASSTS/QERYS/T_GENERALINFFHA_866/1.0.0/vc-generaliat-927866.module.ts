...
import { VcGeneraliat927866Component } from './vc-generaliat-927866.component';


@NgModule({
  declarations: [
    VcGeneraliat927866Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcGeneraliat927866Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcGeneraliat927866Component],
  providers: [
    {
...
export class VcGeneraliat927866Module { }