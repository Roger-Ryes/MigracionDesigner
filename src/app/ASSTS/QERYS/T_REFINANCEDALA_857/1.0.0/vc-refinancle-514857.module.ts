...
import { VcRefinancle514857Component } from './vc-refinancle-514857.component';


@NgModule({
  declarations: [
    VcRefinancle514857Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRefinancle514857Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRefinancle514857Component],
  providers: [
    {
...
export class VcRefinancle514857Module { }