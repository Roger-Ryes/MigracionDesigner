...
import { VcDisbursemt116810Component } from './vc-disbursemt-116810.component';


@NgModule({
  declarations: [
    VcDisbursemt116810Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcDisbursemt116810Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcDisbursemt116810Component],
  providers: [
    {
...
export class VcDisbursemt116810Module { }