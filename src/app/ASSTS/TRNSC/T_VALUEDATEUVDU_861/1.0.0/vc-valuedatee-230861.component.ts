...
import { Model } from './model/vc-valuedatee-230861.model';
import { ViewState } from './model/vc-valuedatee-230861-view-state';
import { VcValuedatee230861Custom } from './vc-valuedatee-230861.custom';
import { ASSTSService} from 'src/app/ASSTS/service-modules/ASSTS.service';
@Component({
selector: 'cobis-vc-valuedatee-230861',
templateUrl: './vc-valuedatee-230861.component.html'
})
export class VcValuedatee230861Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcValuedatee230861Custom(designer.cobisCommons,assts), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
...
let formGroupArray = {
Loan: viewState.T_VALUEDATEUVDU_861.controls.Loan as FormGroup ,
ValueDateFilter: viewState.T_VALUEDATEUVDU_861.controls.ValueDateFilter as FormGroup ,
TransactionLoan: viewState.T_VALUEDATEUVDU_861.controls.TransactionLoan as FormGroup
};
this.metaData = { moduleId: 'ASSTS', subModuleId: 'TRNSC', taskId: 'T_VALUEDATEUVDU_861', taskVersion: '1.0.0', vcId: 'VC_VALUEDATEE_230861', serverEvents: true, pageInfoEvents: new CobisModelPageInfoEvents(false, false), urlRestService: this.designer.cobisCommons.environment.values.dsgUrlRestService + '/ASSTS/TRNSC/T_VALUEDATEUVDU_861', model: new Model(formGroupArray), viewState: viewState, loadCatalogsInfo: new Map<string, ICobisLoadCatalogInfo>([ ]), catalogsCobisInfo: new Map<string, ICobisCatalogCobisInfo>([ ]), queriesInfo: new Map<string, ICobisQueryInfo>([ ['QV_1244_89323', { queryId: 'Q_TRANSACO_1244', entityName: 'TransactionLoan', filter: "", cobisRequestServerConfig: { pageSize :5 }, cache: 0, queryMemberParameters:[ ]}], ]), listsValues: new Map<string, ICobisListValuesInfo>([ ]) , label: 'ValueDateForm' }; this.breadcrumbService.getRoutes(this.metaData);
