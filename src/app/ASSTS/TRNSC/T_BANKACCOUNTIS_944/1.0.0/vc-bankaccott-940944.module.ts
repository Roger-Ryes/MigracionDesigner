...
import { VcBankaccott940944Component } from './vc-bankaccott-940944.component';


@NgModule({
  declarations: [
    VcBankaccott940944Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcBankaccott940944Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcBankaccott940944Component],
  providers: [
    {
...
export class VcBankaccott940944Module { }