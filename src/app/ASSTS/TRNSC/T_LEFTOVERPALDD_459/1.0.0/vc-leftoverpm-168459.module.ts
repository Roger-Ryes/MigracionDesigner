...
import { VcLeftoverpm168459Component } from './vc-leftoverpm-168459.component';


@NgModule({
  declarations: [
    VcLeftoverpm168459Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLeftoverpm168459Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLeftoverpm168459Component],
  providers: [
    {
...
export class VcLeftoverpm168459Module { }