...
import { VcRestructrr543289Component } from './vc-restructrr-543289.component';


@NgModule({
  declarations: [
    VcRestructrr543289Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRestructrr543289Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRestructrr543289Component],
  providers: [
    {
...
export class VcRestructrr543289Module { }