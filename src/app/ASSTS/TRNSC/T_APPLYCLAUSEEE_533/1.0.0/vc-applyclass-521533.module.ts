...
import { VcApplyclass521533Component } from './vc-applyclass-521533.component';


@NgModule({
  declarations: [
    VcApplyclass521533Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcApplyclass521533Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcApplyclass521533Component],
  providers: [
    {
...
export class VcApplyclass521533Module { }