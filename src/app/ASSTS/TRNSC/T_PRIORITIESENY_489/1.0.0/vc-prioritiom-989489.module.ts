...
import { VcPrioritiom989489Component } from './vc-prioritiom-989489.component';


@NgModule({
  declarations: [
    VcPrioritiom989489Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPrioritiom989489Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPrioritiom989489Component],
  providers: [
    {
...
export class VcPrioritiom989489Module { }