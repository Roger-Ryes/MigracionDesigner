...
import { VcPaymentsan916157Component } from './vc-paymentsan-916157.component';


@NgModule({
  declarations: [
    VcPaymentsan916157Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentsan916157Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentsan916157Component],
  providers: [
    {
...
export class VcPaymentsan916157Module { }