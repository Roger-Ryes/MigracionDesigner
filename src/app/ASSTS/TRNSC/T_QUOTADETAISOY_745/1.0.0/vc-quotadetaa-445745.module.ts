...
import { VcQuotadetaa445745Component } from './vc-quotadetaa-445745.component';


@NgModule({
  declarations: [
    VcQuotadetaa445745Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcQuotadetaa445745Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcQuotadetaa445745Component],
  providers: [
    {
...
export class VcQuotadetaa445745Module { }