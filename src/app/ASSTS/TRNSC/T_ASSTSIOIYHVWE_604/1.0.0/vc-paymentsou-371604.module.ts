...
import { VcPaymentsou371604Component } from './vc-paymentsou-371604.component';


@NgModule({
  declarations: [
    VcPaymentsou371604Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentsou371604Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentsou371604Component],
  providers: [
    {
...
export class VcPaymentsou371604Module { }