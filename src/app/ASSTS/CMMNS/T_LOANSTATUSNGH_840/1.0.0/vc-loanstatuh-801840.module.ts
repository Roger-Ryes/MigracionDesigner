...
import { VcLoanstatuh801840Component } from './vc-loanstatuh-801840.component';


@NgModule({
  declarations: [
    VcLoanstatuh801840Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanstatuh801840Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanstatuh801840Component],
  providers: [
    {
...
export class VcLoanstatuh801840Module { }