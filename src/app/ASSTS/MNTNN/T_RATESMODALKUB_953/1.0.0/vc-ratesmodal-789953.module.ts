...
import { VcRatesmodal789953Component } from './vc-ratesmodal-789953.component';


@NgModule({
  declarations: [
    VcRatesmodal789953Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRatesmodal789953Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRatesmodal789953Component],
  providers: [
    {
...
export class VcRatesmodal789953Module { }