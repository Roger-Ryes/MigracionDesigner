...
import { Model } from './model/vc-projectigr-817425.model';
import { ViewState } from './model/vc-projectigr-817425-view-state';
import { VcProjectigr817425Custom } from './vc-projectigr-817425.custom';
import { ASSTSService} from 'src/app/ASSTS/service-modules/ASSTS.service';
@Component({
selector: 'cobis-vc-projectigr-817425',
templateUrl: './vc-projectigr-817425.component.html'
})
export class VcProjectigr817425Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcProjectigr817425Custom(designer.cobisCommons,assts), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
...
let formGroupArray = {
OtherCharges: viewState.T_PROJECTIONTOG_425.controls.OtherCharges as FormGroup
};
this.metaData = { moduleId: 'ASSTS', subModuleId: 'MNTNN', taskId: 'T_PROJECTIONTOG_425', taskVersion: '1.0.0', vcId: 'VC_PROJECTIGR_817425', serverEvents: true, pageInfoEvents: new CobisModelPageInfoEvents(false, false), urlRestService: this.designer.cobisCommons.environment.values.dsgUrlRestService + '/ASSTS/MNTNN/T_PROJECTIONTOG_425', model: new Model(formGroupArray), viewState: viewState, loadCatalogsInfo: new Map<string, ICobisLoadCatalogInfo>([ ]), catalogsCobisInfo: new Map<string, ICobisCatalogCobisInfo>([ ]), queriesInfo: new Map<string, ICobisQueryInfo>([ ['QV_8396_63374', { queryId: 'Q_INGOTRSR_8396', entityName: 'OtherCharges', filter: "", cobisRequestServerConfig: { pageSize :10 }, cache: 0, queryMemberParameters:[ ]}], ]), listsValues: new Map<string, ICobisListValuesInfo>([ ]) , label: 'ProjectionIngresoOtrosCargosForm' }; this.breadcrumbService.getRoutes(this.metaData);
