...
import { VcTestbkyolo973756Component } from './vc-testbkyolo-973756.component';


@NgModule({
  declarations: [
    VcTestbkyolo973756Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcTestbkyolo973756Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcTestbkyolo973756Component],
  providers: [
    {
...
export class VcTestbkyolo973756Module { }