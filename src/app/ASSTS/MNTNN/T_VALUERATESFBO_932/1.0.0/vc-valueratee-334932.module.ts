...
import { VcValueratee334932Component } from './vc-valueratee-334932.component';


@NgModule({
  declarations: [
    VcValueratee334932Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcValueratee334932Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcValueratee334932Component],
  providers: [
    {
...
export class VcValueratee334932Module { }