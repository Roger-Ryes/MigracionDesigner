...
import { VcModalloais799445Component } from './vc-modalloais-799445.component';


@NgModule({
  declarations: [
    VcModalloais799445Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcModalloais799445Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcModalloais799445Component],
  providers: [
    {
...
export class VcModalloais799445Module { }