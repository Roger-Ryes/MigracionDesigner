...
import { VcAssociatai871506Component } from './vc-associatai-871506.component';


@NgModule({
  declarations: [
    VcAssociatai871506Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAssociatai871506Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAssociatai871506Component],
  providers: [
    {
...
export class VcAssociatai871506Module { }