...
import { VcRaterangee778821Component } from './vc-raterangee-778821.component';


@NgModule({
  declarations: [
    VcRaterangee778821Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRaterangee778821Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRaterangee778821Component],
  providers: [
    {
...
export class VcRaterangee778821Module { }