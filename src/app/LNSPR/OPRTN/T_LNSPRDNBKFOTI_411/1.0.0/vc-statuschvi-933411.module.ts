...
import { VcStatuschvi933411Component } from './vc-statuschvi-933411.component';


@NgModule({
  declarations: [
    VcStatuschvi933411Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcStatuschvi933411Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcStatuschvi933411Component],
  providers: [
    {
...
export class VcStatuschvi933411Module { }