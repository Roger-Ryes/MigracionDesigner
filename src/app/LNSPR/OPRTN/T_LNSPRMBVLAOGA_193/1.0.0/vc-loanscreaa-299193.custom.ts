...
import {
  Model
} from './model/vc-loanscreaa-299193.model';
import {
  LNSPRService
...
/* variables locales de T_LNSPRMBVLAOGA_193*/
...
export class VcLoanscreaa299193Custom extends CobisDesignerCustomEvent {
  ...
  task_changeGroup_VC_XKYKWDBATY_881193 = (entities: Model, changeGroupEventArgs: any) => {
  ...
  task_executeCommandCallback_CM_TLNSPRMB_TRO = (
    ...
    if (executeCommandCallbackEventArgs.success) {
      let viewState: any = executeCommandCallbackEventArgs.commons.api.viewState;
      executeCommandCallbackEventArgs.commons.messageHandler.showMessagesInformation("LNSPR.MSG_LNSPR_OPERACIAA_39249", false, null, this.LNSPR.timer);
  ...
  task_initData_VC_LOANSCREAA_299193 = (entities: Model, initDataEventArgs: CobisModelInitDataEventArgs) => {
    ...
    funcionality = this.LNSPR.Utils.IsNullOrEmpty(this.LNSPR.getQueryStrings().funcionality) ? 'C' : this.LNSPR.getQueryStrings().funcionality;
