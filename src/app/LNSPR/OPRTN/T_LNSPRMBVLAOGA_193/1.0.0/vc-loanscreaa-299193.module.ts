...
import { VcLoanscreaa299193Component } from './vc-loanscreaa-299193.component';


@NgModule({
  declarations: [
    VcLoanscreaa299193Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanscreaa299193Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanscreaa299193Component],
  providers: [
    {
...
export class VcLoanscreaa299193Module { }