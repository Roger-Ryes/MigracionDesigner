...
import { VcLoanssimoo401626Component } from './vc-loanssimoo-401626.component';


@NgModule({
  declarations: [
    VcLoanssimoo401626Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanssimoo401626Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanssimoo401626Component],
  providers: [
    {
...
export class VcLoanssimoo401626Module { }