...
import { VcOperatioee354330Component } from './vc-operatioee-354330.component';


@NgModule({
  declarations: [
    VcOperatioee354330Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcOperatioee354330Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcOperatioee354330Component],
  providers: [
    {
...
export class VcOperatioee354330Module { }