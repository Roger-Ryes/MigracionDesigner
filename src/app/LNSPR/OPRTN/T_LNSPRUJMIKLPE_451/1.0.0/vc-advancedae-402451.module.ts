...
import { VcAdvancedae402451Component } from './vc-advancedae-402451.component';


@NgModule({
  declarations: [
    VcAdvancedae402451Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAdvancedae402451Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAdvancedae402451Component],
  providers: [
    {
...
export class VcAdvancedae402451Module { }