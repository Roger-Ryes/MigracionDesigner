...
import { Model } from './model/vc-loansupdee-628908.model';
import { ViewState } from './model/vc-loansupdee-628908-view-state';
import { VcLoansupdee628908Custom } from './vc-loansupdee-628908.custom';
import { LNSPRService} from 'src/app/LNSPR/service-modules/LNSPR.service';
@Component({
selector: 'cobis-vc-loansupdee-628908',
templateUrl: './vc-loansupdee-628908.component.html'
})
export class VcLoansupdee628908Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcLoansupdee628908Custom(designer.cobisCommons,lnspr), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
