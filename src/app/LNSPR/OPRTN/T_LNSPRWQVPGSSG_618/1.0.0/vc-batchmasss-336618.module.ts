...
import { VcBatchmasss336618Component } from './vc-batchmasss-336618.component';


@NgModule({
  declarations: [
    VcBatchmasss336618Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcBatchmasss336618Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcBatchmasss336618Component],
  providers: [
    {
...
export class VcBatchmasss336618Module { }