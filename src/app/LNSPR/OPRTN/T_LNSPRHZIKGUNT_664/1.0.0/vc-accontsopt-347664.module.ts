...
import { VcAccontsopt347664Component } from './vc-accontsopt-347664.component';


@NgModule({
  declarations: [
    VcAccontsopt347664Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAccontsopt347664Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAccontsopt347664Component],
  providers: [
    {
...
export class VcAccontsopt347664Module { }