...
import { VcPaymentsgr815507Component } from './vc-paymentsgr-815507.component';


@NgModule({
  declarations: [
    VcPaymentsgr815507Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentsgr815507Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentsgr815507Component],
  providers: [
    {
...
export class VcPaymentsgr815507Module { }