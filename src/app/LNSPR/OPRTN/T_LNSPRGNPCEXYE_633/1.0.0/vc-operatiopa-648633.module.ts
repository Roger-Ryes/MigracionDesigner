...
import { VcOperatiopa648633Component } from './vc-operatiopa-648633.component';


@NgModule({
  declarations: [
    VcOperatiopa648633Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcOperatiopa648633Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcOperatiopa648633Component],
  providers: [
    {
...
export class VcOperatiopa648633Module { }