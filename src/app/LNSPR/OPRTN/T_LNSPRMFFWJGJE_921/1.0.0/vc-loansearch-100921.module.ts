...
import { VcLoansearch100921Component } from './vc-loansearch-100921.component';


@NgModule({
  declarations: [
    VcLoansearch100921Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansearch100921Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansearch100921Component],
  providers: [
    {
...
export class VcLoansearch100921Module { }