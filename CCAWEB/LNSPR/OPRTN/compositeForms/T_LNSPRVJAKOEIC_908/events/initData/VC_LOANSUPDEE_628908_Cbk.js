...
task.initDataCallback.VC_LOANSUPDEE_628908 = function(entities, initDataCallbackEventArgs) {
   
     if (initDataCallbackEventArgs.success) {
          var oe = entities.OperationEntity;
          var gi = entities.GeneralInformation;
        ...
        suprColAmortization(entities, initDataCallbackEventArgs,'QV_ECPR_JAA30');
     }
};
