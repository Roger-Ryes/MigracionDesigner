...
task.change.VA_TYPEAMORTIZATTN_681198 = function (entities, changedEventArgs) {
    ...
    if(tmpGridAmortization == null){
        tmpGridAmortization = entities.AmortizationEntity.data();
    }
    ...
    case 'MANUAL':
       ...
       // viewState.hide('G_OPERATIANT_136198');
        ...
        viewState.hide('VA_EXTENDEDPAYMEDA_710198');
        changedEventArgs.commons.api.grid.hideGridRowCommand('QV_ECPR_JAA30', entities.AmortizationEntity.data()[entities.AmortizationEntity.data().length-1], 'edit');
        changedEventArgs.commons.api.grid.hideGridRowCommand('QV_ECPR_JAA30', entities.AmortizationEntity.data()[entities.AmortizationEntity.data().length-1], 'delete');
