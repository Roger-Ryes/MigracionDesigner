...
task.gridBeforeEnterInLineRow.QV_ECPR_JAA30 = function (entities, gridBeforeEnterInLineRowEventArgs) {
    gridBeforeEnterInLineRowEventArgs.commons.execServer = false;
    updateFila = true;
    var grid=gridBeforeEnterInLineRowEventArgs.commons.api.grid;
    ...
    var columnas = gridBeforeEnterInLineRowEventArgs.commons.api.vc.viewState.QV_ECPR_JAA30.column;
