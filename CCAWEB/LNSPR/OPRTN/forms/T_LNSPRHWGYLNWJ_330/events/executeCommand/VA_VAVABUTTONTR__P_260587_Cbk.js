...
task.executeCommandCallback.VA_VAVABUTTONTR__P_260587 = function (entities, executeCommandCallbackEventArgs) {
    if (executeCommandCallbackEventArgs.success) {
        ...
        var parentVc = executeCommandCallbackEventArgs.commons.api.parentVc;
