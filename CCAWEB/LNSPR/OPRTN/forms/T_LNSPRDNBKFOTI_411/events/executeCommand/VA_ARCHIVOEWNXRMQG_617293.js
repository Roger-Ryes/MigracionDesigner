...
task.executeCommand.VA_ARCHIVOEWNXRMQG_617293 = function(  entities, executeCommandEventArgs ) {
    
    var fileUpload = executeCommandEventArgs.commons.api.viewState.fileUpload('VA_ARCHIVOEWNXRMQG_617293');
