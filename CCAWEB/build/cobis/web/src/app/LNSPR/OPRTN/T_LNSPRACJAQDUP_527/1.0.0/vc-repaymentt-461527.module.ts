...
import { VcRepaymentt461527Component } from './vc-repaymentt-461527.component';


@NgModule({
  declarations: [
    VcRepaymentt461527Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRepaymentt461527Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRepaymentt461527Component],
  providers: [
    {
...
export class VcRepaymentt461527Module { }