...
import { VcPassivepte108832Component } from './vc-passivepte-108832.component';


@NgModule({
  declarations: [
    VcPassivepte108832Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPassivepte108832Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPassivepte108832Component],
  providers: [
    {
...
export class VcPassivepte108832Module { }