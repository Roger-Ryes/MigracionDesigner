...
import { VcLoansalede341511Component } from './vc-loansalede-341511.component';


@NgModule({
  declarations: [
    VcLoansalede341511Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansalede341511Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansalede341511Component],
  providers: [
    {
...
export class VcLoansalede341511Module { }