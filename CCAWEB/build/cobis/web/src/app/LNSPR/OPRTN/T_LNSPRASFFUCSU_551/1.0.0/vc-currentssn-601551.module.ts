...
import { VcCurrentssn601551Component } from './vc-currentssn-601551.component';


@NgModule({
  declarations: [
    VcCurrentssn601551Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcCurrentssn601551Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcCurrentssn601551Component],
  providers: [
    {
...
export class VcCurrentssn601551Module { }