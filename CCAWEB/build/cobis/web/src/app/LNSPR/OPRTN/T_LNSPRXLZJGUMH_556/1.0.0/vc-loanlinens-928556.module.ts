...
import { VcLoanlinens928556Component } from './vc-loanlinens-928556.component';


@NgModule({
  declarations: [
    VcLoanlinens928556Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanlinens928556Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanlinens928556Component],
  providers: [
    {
...
export class VcLoanlinens928556Module { }