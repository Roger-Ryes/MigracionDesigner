...
import { VcLoansopetn404268Component } from './vc-loansopetn-404268.component';


@NgModule({
  declarations: [
    VcLoansopetn404268Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansopetn404268Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansopetn404268Component],
  providers: [
    {
...
export class VcLoansopetn404268Module { }