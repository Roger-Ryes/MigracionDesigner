...
import { VcSyndicatdi660858Component } from './vc-syndicatdi-660858.component';


@NgModule({
  declarations: [
    VcSyndicatdi660858Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcSyndicatdi660858Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcSyndicatdi660858Component],
  providers: [
    {
...
export class VcSyndicatdi660858Module { }