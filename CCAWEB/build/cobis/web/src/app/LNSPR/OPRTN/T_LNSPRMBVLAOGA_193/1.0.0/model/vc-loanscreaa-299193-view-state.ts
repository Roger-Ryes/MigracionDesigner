...
public T_LNSPRMBVLAOGA_193!:FormGroup;
public VC_LOANSCREAA_299193:CobisGroupBoxModel = new CobisGroupBoxModel();
public VC_XKYKWDBATY_881193 : CobisTabbedLayoutContainerModel = new CobisTabbedLayoutContainerModel();
public VC_ZHQUMTXXGR_635193_tab : CobisTabbedLayoutTabModel = new CobisTabbedLayoutTabModel();
public VC_ZHQUMTXXGR_635193 : CobisGroupBoxModel = new CobisGroupBoxModel();
public VC_DLACTGOIYU_206539 : CobisGroupBoxModel = new CobisGroupBoxModel();
...
public VC_ZUGXQMZUBQ_554193_tab : CobisTabbedLayoutTabModel = new CobisTabbedLayoutTabModel();
public VC_ZUGXQMZUBQ_554193 : CobisGroupBoxModel = new CobisGroupBoxModel();
public VC_BOMUHDCOZU_819330 : CobisGroupBoxModel = new CobisGroupBoxModel();
...
public VC_UQBPHFCKCW_777193_tab : CobisTabbedLayoutTabModel = new CobisTabbedLayoutTabModel();
public VC_UQBPHFCKCW_777193 : CobisGroupBoxModel = new CobisGroupBoxModel();
public VC_COMXQAMSFB_808785 : CobisGroupBoxModel = new CobisGroupBoxModel();
...
public VC_BKTCDNSADU_521193_tab : CobisTabbedLayoutTabModel = new CobisTabbedLayoutTabModel();
public VC_BKTCDNSADU_521193 : CobisGroupBoxModel = new CobisGroupBoxModel();
public VC_EPCZGFTKLP_157633 : CobisGroupBoxModel = new CobisGroupBoxModel();
...
public CM_TLNSPRMB_TRO: CobisButtonModel = new CobisButtonModel();
constructor(cobis: CobisCommonsService,private formBuilder: FormBuilder, private mode: number) {
this.VC_LOANSCREAA_299193.id="VC_LOANSCREAA_299193";
this.VC_LOANSCREAA_299193.name="ViewContainerBase";
this.VC_LOANSCREAA_299193.colSpan=1;
this.VC_LOANSCREAA_299193.columns=1;
this.VC_LOANSCREAA_299193.enabled=ConstantsApi.mode.All;
this.VC_XKYKWDBATY_881193.id="VC_XKYKWDBATY_881193";
this.VC_XKYKWDBATY_881193.name="ViewContainerBase";
this.VC_XKYKWDBATY_881193.tabPosition=PositionTab.TOP;
this.VC_XKYKWDBATY_881193.enabled=ConstantsApi.mode.All;
this.VC_XKYKWDBATY_881193.childrenGroups = ["VC_ZHQUMTXXGR_635193_tab","VC_ZUGXQMZUBQ_554193_tab","VC_UQBPHFCKCW_777193_tab","VC_BKTCDNSADU_521193_tab"];
this.VC_ZHQUMTXXGR_635193.id="VC_ZHQUMTXXGR_635193";
this.VC_ZHQUMTXXGR_635193.name="ViewContainerBase";
this.VC_ZHQUMTXXGR_635193.enabled=ConstantsApi.mode.All;
this.VC_ZHQUMTXXGR_635193.colSpan=1;
this.VC_ZHQUMTXXGR_635193.columns=1;
this.VC_ZHQUMTXXGR_635193_tab.id="VC_ZHQUMTXXGR_635193_tab";
this.VC_ZHQUMTXXGR_635193_tab.name="ViewContainerBase";
this.VC_ZHQUMTXXGR_635193_tab.enabled=ConstantsApi.mode.All;
this.VC_ZHQUMTXXGR_635193_tab.colSpan=1;
this.VC_ZHQUMTXXGR_635193_tab.label = cobis.translate("LNSPR.LBL_LNSPR_INACINGNN_54588");
this.VC_DLACTGOIYU_206539.id="VC_DLACTGOIYU_206539";
this.VC_DLACTGOIYU_206539.name="OperationLoansForm";
this.VC_DLACTGOIYU_206539.enabled=ConstantsApi.mode.All;
this.VC_DLACTGOIYU_206539.colSpan=1;
this.VC_DLACTGOIYU_206539.columns=1;
...
this.VC_ZUGXQMZUBQ_554193.id="VC_ZUGXQMZUBQ_554193";
this.VC_ZUGXQMZUBQ_554193.name="ViewContainerBase";
this.VC_ZUGXQMZUBQ_554193.enabled=ConstantsApi.mode.All;
this.VC_ZUGXQMZUBQ_554193.colSpan=1;
this.VC_ZUGXQMZUBQ_554193.columns=1;
this.VC_ZUGXQMZUBQ_554193_tab.id="VC_ZUGXQMZUBQ_554193_tab";
this.VC_ZUGXQMZUBQ_554193_tab.name="ViewContainerBase";
this.VC_ZUGXQMZUBQ_554193_tab.enabled=ConstantsApi.mode.All;
this.VC_ZUGXQMZUBQ_554193_tab.colSpan=1;
this.VC_ZUGXQMZUBQ_554193_tab.label = cobis.translate("LNSPR.LBL_LNSPR_RUBROSIFS_16769");
this.VC_BOMUHDCOZU_819330.id="VC_BOMUHDCOZU_819330";
this.VC_BOMUHDCOZU_819330.name="OperationItems";
this.VC_BOMUHDCOZU_819330.enabled=ConstantsApi.mode.All;
this.VC_BOMUHDCOZU_819330.colSpan=1;
this.VC_BOMUHDCOZU_819330.columns=1;
...
this.VC_UQBPHFCKCW_777193.id="VC_UQBPHFCKCW_777193";
this.VC_UQBPHFCKCW_777193.name="ViewContainerBase";
this.VC_UQBPHFCKCW_777193.enabled=ConstantsApi.mode.All;
this.VC_UQBPHFCKCW_777193.colSpan=1;
this.VC_UQBPHFCKCW_777193.columns=1;
this.VC_UQBPHFCKCW_777193_tab.id="VC_UQBPHFCKCW_777193_tab";
this.VC_UQBPHFCKCW_777193_tab.name="ViewContainerBase";
this.VC_UQBPHFCKCW_777193_tab.enabled=ConstantsApi.mode.All;
this.VC_UQBPHFCKCW_777193_tab.colSpan=1;
this.VC_UQBPHFCKCW_777193_tab.label = cobis.translate("LNSPR.LBL_LNSPR_PARMETROG_15063");
this.VC_COMXQAMSFB_808785.id="VC_COMXQAMSFB_808785";
this.VC_COMXQAMSFB_808785.name="OperationLoansGeneralParametersForm";
this.VC_COMXQAMSFB_808785.enabled=ConstantsApi.mode.All;
this.VC_COMXQAMSFB_808785.colSpan=1;
this.VC_COMXQAMSFB_808785.columns=1;
...
this.VC_BKTCDNSADU_521193.id="VC_BKTCDNSADU_521193";
this.VC_BKTCDNSADU_521193.name="ViewContainerBase";
this.VC_BKTCDNSADU_521193.enabled=ConstantsApi.mode.All;
this.VC_BKTCDNSADU_521193.colSpan=1;
this.VC_BKTCDNSADU_521193.columns=1;
this.VC_BKTCDNSADU_521193_tab.id="VC_BKTCDNSADU_521193_tab";
this.VC_BKTCDNSADU_521193_tab.name="ViewContainerBase";
this.VC_BKTCDNSADU_521193_tab.enabled=ConstantsApi.mode.All;
this.VC_BKTCDNSADU_521193_tab.colSpan=1;
this.VC_BKTCDNSADU_521193_tab.label = cobis.translate("LNSPR.LBL_LNSPR_AMORTIZII_74160");
this.VC_EPCZGFTKLP_157633.id="VC_EPCZGFTKLP_157633";
this.VC_EPCZGFTKLP_157633.name="OperationPaymentDayUpdateForm";
this.VC_EPCZGFTKLP_157633.enabled=ConstantsApi.mode.All;
this.VC_EPCZGFTKLP_157633.colSpan=1;
this.VC_EPCZGFTKLP_157633.columns=1;
...
this.CM_TLNSPRMB_TRO.id = "CM_TLNSPRMB_TRO";
this.CM_TLNSPRMB_TRO.name = "Command1";
this.CM_TLNSPRMB_TRO.causesValidation=false;
this.CM_TLNSPRMB_TRO.submitOnEnter=false;
this.CM_TLNSPRMB_TRO.setFocus=false;
this.CM_TLNSPRMB_TRO.close=false;
this.CM_TLNSPRMB_TRO.label = cobis.translate("LNSPR.LBL_LNSPR_TRANSMIRR_86351");
this.CM_TLNSPRMB_TRO.enabled = ConstantsApi.mode.All;
this.CM_TLNSPRMB_TRO.visible= ConstantsApi.mode.All;
...
this.T_LNSPRMBVLAOGA_193 = this.formBuilder.group({
