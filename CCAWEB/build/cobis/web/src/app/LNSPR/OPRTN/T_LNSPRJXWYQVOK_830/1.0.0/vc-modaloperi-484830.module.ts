...
import { VcModaloperi484830Component } from './vc-modaloperi-484830.component';


@NgModule({
  declarations: [
    VcModaloperi484830Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcModaloperi484830Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcModaloperi484830Component],
  providers: [
    {
...
export class VcModaloperi484830Module { }