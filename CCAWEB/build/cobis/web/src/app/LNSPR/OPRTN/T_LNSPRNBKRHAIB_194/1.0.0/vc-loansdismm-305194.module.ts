...
import { VcLoansdismm305194Component } from './vc-loansdismm-305194.component';


@NgModule({
  declarations: [
    VcLoansdismm305194Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansdismm305194Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansdismm305194Component],
  providers: [
    {
...
export class VcLoansdismm305194Module { }