...
import { VcLoansliner641705Component } from './vc-loansliner-641705.component';


@NgModule({
  declarations: [
    VcLoansliner641705Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansliner641705Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansliner641705Component],
  providers: [
    {
...
export class VcLoansliner641705Module { }