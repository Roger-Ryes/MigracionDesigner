...
import { VcModalrefte678446Component } from './vc-modalrefte-678446.component';


@NgModule({
  declarations: [
    VcModalrefte678446Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcModalrefte678446Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcModalrefte678446Component],
  providers: [
    {
...
export class VcModalrefte678446Module { }