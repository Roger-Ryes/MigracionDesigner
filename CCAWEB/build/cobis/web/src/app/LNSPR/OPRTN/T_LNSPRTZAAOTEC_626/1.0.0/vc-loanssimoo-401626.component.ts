...
import { Model } from './model/vc-loanssimoo-401626.model';
import { ViewState } from './model/vc-loanssimoo-401626-view-state';
import { VcLoanssimoo401626Custom } from './vc-loanssimoo-401626.custom';
import { LNSPRService} from 'src/app/LNSPR/service-modules/LNSPR.service';
@Component({
selector: 'cobis-vc-loanssimoo-401626',
templateUrl: './vc-loanssimoo-401626.component.html'
})
export class VcLoanssimoo401626Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcLoanssimoo401626Custom(designer.cobisCommons,lnspr), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
