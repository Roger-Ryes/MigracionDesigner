...
import { VcPassivepif144956Component } from './vc-passivepif-144956.component';


@NgModule({
  declarations: [
    VcPassivepif144956Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPassivepif144956Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPassivepif144956Component],
  providers: [
    {
...
export class VcPassivepif144956Module { }