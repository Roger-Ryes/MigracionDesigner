...
import { VcGeneralian158721Component } from './vc-generalian-158721.component';


@NgModule({
  declarations: [
    VcGeneralian158721Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcGeneralian158721Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcGeneralian158721Component],
  providers: [
    {
...
export class VcGeneralian158721Module { }