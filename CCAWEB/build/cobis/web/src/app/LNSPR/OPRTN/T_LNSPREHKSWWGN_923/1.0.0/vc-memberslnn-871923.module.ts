...
import { VcMemberslnn871923Component } from './vc-memberslnn-871923.component';


@NgModule({
  declarations: [
    VcMemberslnn871923Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcMemberslnn871923Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcMemberslnn871923Component],
  providers: [
    {
...
export class VcMemberslnn871923Module { }