...
import { VcOfficialnf999423Component } from './vc-officialnf-999423.component';


@NgModule({
  declarations: [
    VcOfficialnf999423Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcOfficialnf999423Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcOfficialnf999423Component],
  providers: [
    {
...
export class VcOfficialnf999423Module { }