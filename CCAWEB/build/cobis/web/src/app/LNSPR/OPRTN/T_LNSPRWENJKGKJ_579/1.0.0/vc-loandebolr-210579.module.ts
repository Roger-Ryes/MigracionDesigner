...
import { VcLoandebolr210579Component } from './vc-loandebolr-210579.component';


@NgModule({
  declarations: [
    VcLoandebolr210579Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoandebolr210579Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoandebolr210579Component],
  providers: [
    {
...
export class VcLoandebolr210579Module { }