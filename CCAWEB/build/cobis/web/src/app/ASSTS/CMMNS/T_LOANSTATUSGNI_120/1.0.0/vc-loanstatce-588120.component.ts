...
import { Model } from './model/vc-loanstatce-588120.model';
import { ViewState } from './model/vc-loanstatce-588120-view-state';
import { VcLoanstatce588120Custom } from './vc-loanstatce-588120.custom';
import { ASSTSService} from 'src/app/ASSTS/service-modules/ASSTS.service';
@Component({
selector: 'cobis-vc-loanstatce-588120',
templateUrl: './vc-loanstatce-588120.component.html'
})
export class VcLoanstatce588120Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcLoanstatce588120Custom(designer.cobisCommons,assts), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
...
let formGroupArray = {
Loan: viewState.T_LOANSTATUSGNI_120.controls.Loan as FormGroup ,
Amortization: viewState.T_LOANSTATUSGNI_120.controls.Amortization as FormGroup ,
ItemsLoan: viewState.T_LOANSTATUSGNI_120.controls.ItemsLoan as FormGroup
};
this.metaData = { moduleId: 'ASSTS', subModuleId: 'CMMNS', taskId: 'T_LOANSTATUSGNI_120', taskVersion: '1.0.0', vcId: 'VC_LOANSTATCE_588120', serverEvents: true, pageInfoEvents: new CobisModelPageInfoEvents(true, false), urlRestService: this.designer.cobisCommons.environment.values.dsgUrlRestService + '/ASSTS/CMMNS/T_LOANSTATUSGNI_120', model: new Model(formGroupArray), viewState: viewState, loadCatalogsInfo: new Map<string, ICobisLoadCatalogInfo>([ ['VA_NEWSTATUSLZHCOE_110722', { filter:"", cobisRequestServerConfig: null, cache: 0 }], ]), catalogsCobisInfo: new Map<string, ICobisCatalogCobisInfo>([ ]), queriesInfo: new Map<string, ICobisQueryInfo>([ ['QV_LM37_VTI26', { queryId: 'Q_AMORTIAN_8237', entityName: 'Amortization', filter: "", cobisRequestServerConfig: { pageSize :12 }, cache: 0, queryMemberParameters:[ ]}], ]), listsValues: new Map<string, ICobisListValuesInfo>([ ]) , label: 'ASSTS.LBL_ASSTS_CAMBIOEOA_47107' }; this.breadcrumbService.getRoutes(this.metaData);
