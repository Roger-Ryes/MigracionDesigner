...
import { VcAmortizatt397548Component } from './vc-amortizatt-397548.component';


@NgModule({
  declarations: [
    VcAmortizatt397548Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAmortizatt397548Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAmortizatt397548Component],
  providers: [
    {
...
export class VcAmortizatt397548Module { }