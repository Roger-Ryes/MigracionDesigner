...
import { Model } from './model/vc-amortizaii-339261.model';
import { ViewState } from './model/vc-amortizaii-339261-view-state';
import { VcAmortizaii339261Custom } from './vc-amortizaii-339261.custom';
import { ASSTSService} from 'src/app/ASSTS/service-modules/ASSTS.service';
@Component({
selector: 'cobis-vc-amortizaii-339261',
templateUrl: './vc-amortizaii-339261.component.html'
})
export class VcAmortizaii339261Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcAmortizaii339261Custom(designer.cobisCommons,assts), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
...
let formGroupArray = {
Amortization: viewState.T_AMORTIZATIOON_261.controls.Amortization as FormGroup ,
ItemsLoan: viewState.T_AMORTIZATIOON_261.controls.ItemsLoan as FormGroup
};
this.metaData = { moduleId: 'ASSTS', subModuleId: 'CMMNS', taskId: 'T_AMORTIZATIOON_261', taskVersion: '1.0.0', vcId: 'VC_AMORTIZAII_339261', serverEvents: true, pageInfoEvents: new CobisModelPageInfoEvents(true, false), urlRestService: this.designer.cobisCommons.environment.values.dsgUrlRestService + '/ASSTS/CMMNS/T_AMORTIZATIOON_261', model: new Model(formGroupArray), viewState: viewState, loadCatalogsInfo: new Map<string, ICobisLoadCatalogInfo>([ ]), catalogsCobisInfo: new Map<string, ICobisCatalogCobisInfo>([ ]), queriesInfo: new Map<string, ICobisQueryInfo>([ ['QV_LM37_VTI26', { queryId: 'Q_AMORTIAN_8237', entityName: 'Amortization', filter: "", cobisRequestServerConfig: { pageSize :12 }, cache: 0, queryMemberParameters:[ ]}], ]), listsValues: new Map<string, ICobisListValuesInfo>([ ]) , label: 'AmortizationForm' }; this.breadcrumbService.getRoutes(this.metaData);
