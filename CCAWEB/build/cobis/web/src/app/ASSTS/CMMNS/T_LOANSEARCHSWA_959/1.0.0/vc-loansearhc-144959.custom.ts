...
export class VcLoansearhc144959Custom extends CobisDesignerCustomEvent {
  ...
  task_executeQuery_Q_LOANDPQM_3009 = (executeQueryEventArgs: CobisModelExecuteQueryEventArgs) => {
    ...
    if (this.queryString.menu == this.ASSTS.Constants.MENU_DISBUSMNT_PART) {
  ...
  task_gridRowSelecting_QV_3009_96085 = (
    ...
    switch (this.queryString.menu) {
      ...
      case this.ASSTS.Constants.MENU_PROYECTINST:
        subModuleId = "MNTNN";
        ...
        break;
      case this.ASSTS.Constants.MENU_ASSTSSZCLDZTQ:
        subModuleId = "TRNSC";
        ...
        break;
      case this.ASSTS.Constants.MENU_DISBUSMNT_PART:
        subModuleId = "TRNSC";
        ...
        break;
      case this.ASSTS.Constants.MENU_SIM_REAJ:
    ...
    this.ASSTS.Navigation.taskRedirect(subModuleId, taskId, vcId, label, gridRowSelectingEventArgs, parameters);
  };
