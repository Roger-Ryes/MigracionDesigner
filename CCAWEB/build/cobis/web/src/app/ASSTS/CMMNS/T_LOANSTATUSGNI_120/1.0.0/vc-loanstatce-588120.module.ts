...
import { VcLoanstatce588120Component } from './vc-loanstatce-588120.component';


@NgModule({
  declarations: [
    VcLoanstatce588120Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanstatce588120Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanstatce588120Component],
  providers: [
    {
...
export class VcLoanstatce588120Module { }