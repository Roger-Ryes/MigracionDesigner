...
import { VcAdvancedar764220Component } from './vc-advancedar-764220.component';


@NgModule({
  declarations: [
    VcAdvancedar764220Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAdvancedar764220Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAdvancedar764220Component],
  providers: [
    {
...
export class VcAdvancedar764220Module { }