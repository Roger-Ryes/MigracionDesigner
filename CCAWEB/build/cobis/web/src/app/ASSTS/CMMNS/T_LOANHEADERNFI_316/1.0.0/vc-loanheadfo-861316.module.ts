...
import { VcLoanheadfo861316Component } from './vc-loanheadfo-861316.component';


@NgModule({
  declarations: [
    VcLoanheadfo861316Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanheadfo861316Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanheadfo861316Component],
  providers: [
    {
...
export class VcLoanheadfo861316Module { }