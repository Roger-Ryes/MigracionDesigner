...
import { VcProjectigr817425Component } from './vc-projectigr-817425.component';


@NgModule({
  declarations: [
    VcProjectigr817425Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcProjectigr817425Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcProjectigr817425Component],
  providers: [
    {
...
export class VcProjectigr817425Module { }