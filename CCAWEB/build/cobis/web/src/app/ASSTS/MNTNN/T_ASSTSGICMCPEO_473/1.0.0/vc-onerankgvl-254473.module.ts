...
import { VcOnerankgvl254473Component } from './vc-onerankgvl-254473.component';


@NgModule({
  declarations: [
    VcOnerankgvl254473Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcOnerankgvl254473Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcOnerankgvl254473Component],
  providers: [
    {
...
export class VcOnerankgvl254473Module { }