...
import { VcPaymentmda338828Component } from './vc-paymentmda-338828.component';


@NgModule({
  declarations: [
    VcPaymentmda338828Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentmda338828Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentmda338828Component],
  providers: [
    {
...
export class VcPaymentmda338828Module { }