...
import { VcAggregatrt463195Component } from './vc-aggregatrt-463195.component';


@NgModule({
  declarations: [
    VcAggregatrt463195Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAggregatrt463195Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAggregatrt463195Component],
  providers: [
    {
...
export class VcAggregatrt463195Module { }