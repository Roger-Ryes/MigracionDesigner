...
import { VcReajustekp207872Component } from './vc-reajustekp-207872.component';


@NgModule({
  declarations: [
    VcReajustekp207872Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcReajustekp207872Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcReajustekp207872Component],
  providers: [
    {
...
export class VcReajustekp207872Module { }