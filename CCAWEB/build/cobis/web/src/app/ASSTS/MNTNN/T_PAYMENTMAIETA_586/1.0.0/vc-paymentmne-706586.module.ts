...
import { VcPaymentmne706586Component } from './vc-paymentmne-706586.component';


@NgModule({
  declarations: [
    VcPaymentmne706586Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentmne706586Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentmne706586Component],
  providers: [
    {
...
export class VcPaymentmne706586Module { }