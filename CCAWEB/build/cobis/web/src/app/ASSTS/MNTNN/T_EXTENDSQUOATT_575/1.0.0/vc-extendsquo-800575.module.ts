...
import { VcExtendsquo800575Component } from './vc-extendsquo-800575.component';


@NgModule({
  declarations: [
    VcExtendsquo800575Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcExtendsquo800575Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcExtendsquo800575Component],
  providers: [
    {
...
export class VcExtendsquo800575Module { }