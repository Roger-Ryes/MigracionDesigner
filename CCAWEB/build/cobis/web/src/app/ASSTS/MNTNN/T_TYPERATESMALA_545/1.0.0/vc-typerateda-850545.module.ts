...
import { VcTyperateda850545Component } from './vc-typerateda-850545.component';


@NgModule({
  declarations: [
    VcTyperateda850545Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcTyperateda850545Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcTyperateda850545Component],
  providers: [
    {
...
export class VcTyperateda850545Module { }