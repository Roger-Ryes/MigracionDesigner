...
import { VcTworangess307887Component } from './vc-tworangess-307887.component';


@NgModule({
  declarations: [
    VcTworangess307887Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcTworangess307887Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcTworangess307887Component],
  providers: [
    {
...
export class VcTworangess307887Module { }