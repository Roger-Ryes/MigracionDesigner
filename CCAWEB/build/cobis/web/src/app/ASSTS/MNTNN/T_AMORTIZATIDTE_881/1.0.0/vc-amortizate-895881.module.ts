...
import { VcAmortizate895881Component } from './vc-amortizate-895881.component';


@NgModule({
  declarations: [
    VcAmortizate895881Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcAmortizate895881Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcAmortizate895881Component],
  providers: [
    {
...
export class VcAmortizate895881Module { }