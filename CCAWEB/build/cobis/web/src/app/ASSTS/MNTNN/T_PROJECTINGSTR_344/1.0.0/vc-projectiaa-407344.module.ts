...
import { VcProjectiaa407344Component } from './vc-projectiaa-407344.component';


@NgModule({
  declarations: [
    VcProjectiaa407344Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcProjectiaa407344Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcProjectiaa407344Component],
  providers: [
    {
...
export class VcProjectiaa407344Module { }