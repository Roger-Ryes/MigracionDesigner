...
import { VcReajustemf502264Component } from './vc-reajustemf-502264.component';


@NgModule({
  declarations: [
    VcReajustemf502264Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcReajustemf502264Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcReajustemf502264Component],
  providers: [
    {
...
export class VcReajustemf502264Module { }