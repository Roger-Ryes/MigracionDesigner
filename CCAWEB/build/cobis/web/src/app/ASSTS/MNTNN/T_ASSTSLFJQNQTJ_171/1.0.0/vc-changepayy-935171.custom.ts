  ...
  task_executeCommand_CM_TASSTSLF_TT1 = async (
    ...
    if (motivo != undefined) {
      if (diaActual == diaNuevo) {
        executeCommandEventArgs.commons.messageHandler.showMessagesInformation('ASSTS.MSG_ASSTS_DADEPAGSE_14590', false, null, this.ASSTS.timer);
      ...
      executeCommandEventArgs.commons.messageHandler.showMessagesInformation('ASSTS.MSG_ASSTS_ELMOTIVEE_44777', false, null, this.ASSTS.timer);
    }
  };
