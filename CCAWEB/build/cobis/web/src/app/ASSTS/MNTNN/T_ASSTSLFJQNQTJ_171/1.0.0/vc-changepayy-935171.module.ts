...
import { VcChangepayy935171Component } from './vc-changepayy-935171.component';


@NgModule({
  declarations: [
    VcChangepayy935171Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcChangepayy935171Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcChangepayy935171Component],
  providers: [
    {
...
export class VcChangepayy935171Module { }