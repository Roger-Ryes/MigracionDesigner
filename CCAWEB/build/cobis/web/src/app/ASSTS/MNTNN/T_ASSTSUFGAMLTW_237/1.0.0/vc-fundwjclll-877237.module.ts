...
import { VcFundwjclll877237Component } from './vc-fundwjclll-877237.component';


@NgModule({
  declarations: [
    VcFundwjclll877237Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcFundwjclll877237Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcFundwjclll877237Component],
  providers: [
    {
...
export class VcFundwjclll877237Module { }