...
import { VcProjectito707621Component } from './vc-projectito-707621.component';


@NgModule({
  declarations: [
    VcProjectito707621Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcProjectito707621Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcProjectito707621Component],
  providers: [
    {
...
export class VcProjectito707621Module { }