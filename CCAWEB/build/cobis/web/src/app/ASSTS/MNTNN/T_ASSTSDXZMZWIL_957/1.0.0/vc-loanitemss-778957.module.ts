...
import { VcLoanitemss778957Component } from './vc-loanitemss-778957.component';


@NgModule({
  declarations: [
    VcLoanitemss778957Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanitemss778957Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanitemss778957Component],
  providers: [
    {
...
export class VcLoanitemss778957Module { }