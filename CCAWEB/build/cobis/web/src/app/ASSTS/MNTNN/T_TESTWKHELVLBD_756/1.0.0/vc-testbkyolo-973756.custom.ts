...
export class VcTestbkyolo973756Custom extends CobisDesignerCustomEvent {
  ...
  task_change_VA_2011UKZSBSFRWRA_245872 = (entities: Model, changeEventArgs: any) => {
    ...
    if (!reference) {
      if (value > valueMax) {
        changeEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11973", false, null, this.ASSTS.timer);
        return;
      }
      if (value < valueMin) {
        changeEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11974", false, null, this.ASSTS.timer);
        return;
      }
    }
  ...
  task_change_VA_DIVUPQPVWWEQDNI_233872 = (entities: Model, changeEventArgs: any) => {
    ...
    if (divUp < 0) {
      changeEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11972", false, null, this.ASSTS.timer);
      return;
    }
    if (iniDiv < 0) {
    ...
    if (iniDiv > divUp) {
      changeEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11969", false, null, this.ASSTS.timer);
      return;
    }
  };
  ...
  task_executeCommand_CM_TTESTWKH_NN5 = (
    ...
    if ((iniDiv < 0) || iniDiv > 32767) {
      executeCommandEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11968", false, null, this.ASSTS.timer);
      return;
    }
    ...
    if (iniDiv > divUp) {
      executeCommandEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11969", false, null, this.ASSTS.timer);
      return;
    }
    if (iniDiv > divUp) {
      executeCommandEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11969", false, null, this.ASSTS.timer);
    ...
    if (value < 0) {
      executeCommandEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11978", false, null, this.ASSTS.timer);
      return;
    }
    if (reference != null) {
      if (value > valueMax) {
        executeCommandEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11973", false, null, this.ASSTS.timer);
        return;
      }
      if (value < valueMin) {
        executeCommandEventArgs.commons.messageHandler.showMessagesInformation("ASSTS.MSG_ASSTS_SEDEBERZE_11974", false, null, this.ASSTS.timer);
        return;
      }
    }
    if (mode === 1) {
