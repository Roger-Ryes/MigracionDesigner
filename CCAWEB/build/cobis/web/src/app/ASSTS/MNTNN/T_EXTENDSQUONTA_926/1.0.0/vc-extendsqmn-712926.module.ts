...
import { VcExtendsqmn712926Component } from './vc-extendsqmn-712926.component';


@NgModule({
  declarations: [
    VcExtendsqmn712926Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcExtendsqmn712926Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcExtendsqmn712926Component],
  providers: [
    {
...
export class VcExtendsqmn712926Module { }