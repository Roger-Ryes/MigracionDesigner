...
import { VcPassivepof610117Component } from './vc-passivepof-610117.component';


@NgModule({
  declarations: [
    VcPassivepof610117Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPassivepof610117Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPassivepof610117Component],
  providers: [
    {
...
export class VcPassivepof610117Module { }