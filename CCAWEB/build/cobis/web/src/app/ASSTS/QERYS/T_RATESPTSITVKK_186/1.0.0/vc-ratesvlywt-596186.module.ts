...
import { VcRatesvlywt596186Component } from './vc-ratesvlywt-596186.component';


@NgModule({
  declarations: [
    VcRatesvlywt596186Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRatesvlywt596186Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRatesvlywt596186Component],
  providers: [
    {
...
export class VcRatesvlywt596186Module { }