...
import { VcLoanguarne277791Component } from './vc-loanguarne-277791.component';


@NgModule({
  declarations: [
    VcLoanguarne277791Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanguarne277791Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanguarne277791Component],
  providers: [
    {
...
export class VcLoanguarne277791Module { }