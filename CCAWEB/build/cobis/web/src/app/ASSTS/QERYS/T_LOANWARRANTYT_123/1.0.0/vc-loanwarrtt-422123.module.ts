...
import { VcLoanwarrtt422123Component } from './vc-loanwarrtt-422123.component';


@NgModule({
  declarations: [
    VcLoanwarrtt422123Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanwarrtt422123Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanwarrtt422123Component],
  providers: [
    {
...
export class VcLoanwarrtt422123Module { }