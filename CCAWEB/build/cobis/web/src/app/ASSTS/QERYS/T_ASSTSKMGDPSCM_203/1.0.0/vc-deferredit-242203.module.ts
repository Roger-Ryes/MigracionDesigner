...
import { VcDeferredit242203Component } from './vc-deferredit-242203.component';


@NgModule({
  declarations: [
    VcDeferredit242203Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcDeferredit242203Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcDeferredit242203Component],
  providers: [
    {
...
export class VcDeferredit242203Module { }