...
import {
  Model
} from './model/vc-refinancle-514857.model';
import {
  ASSTSService
...
export class VcRefinancle514857Custom extends CobisDesignerCustomEvent {
  ...
  //Start signature to Callback event to Q_REFINAOS_1949
  task_executeQueryCallback_Q_REFINAOS_1949 = (
    entities: Model,
