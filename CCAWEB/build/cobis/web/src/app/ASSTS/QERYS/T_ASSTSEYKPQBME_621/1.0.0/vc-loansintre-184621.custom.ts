...
import {
  Model
} from './model/vc-loansintre-184621.model';
import {
  ASSTSService
...
/* variables locales de T_ASSTSEYKPQBME_621*/

export class VcLoansintre184621Custom extends CobisDesignerCustomEvent {
  ...
  //Start signature to Callback event to Q_LOANLIIR_OP62
  task_executeQueryCallback_Q_LOANLIIR_OP62 = (
    entities: Model,
