...
import { VcGeneraliao289119Component } from './vc-generaliao-289119.component';


@NgModule({
  declarations: [
    VcGeneraliao289119Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcGeneraliao289119Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcGeneraliao289119Component],
  providers: [
    {
...
export class VcGeneraliao289119Module { }