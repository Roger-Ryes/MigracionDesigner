...
import { VcLoandebtrr256168Component } from './vc-loandebtrr-256168.component';


@NgModule({
  declarations: [
    VcLoandebtrr256168Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoandebtrr256168Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoandebtrr256168Component],
  providers: [
    {
...
export class VcLoandebtrr256168Module { }