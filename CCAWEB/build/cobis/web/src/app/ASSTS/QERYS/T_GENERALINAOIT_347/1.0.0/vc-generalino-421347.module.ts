...
import { VcGeneralino421347Component } from './vc-generalino-421347.component';


@NgModule({
  declarations: [
    VcGeneralino421347Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcGeneralino421347Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcGeneralino421347Component],
  providers: [
    {
...
export class VcGeneralino421347Module { }