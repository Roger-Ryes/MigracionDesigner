...
import { VcLoantrantc731694Component } from './vc-loantrantc-731694.component';


@NgModule({
  declarations: [
    VcLoantrantc731694Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoantrantc731694Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoantrantc731694Component],
  providers: [
    {
...
export class VcLoantrantc731694Module { }