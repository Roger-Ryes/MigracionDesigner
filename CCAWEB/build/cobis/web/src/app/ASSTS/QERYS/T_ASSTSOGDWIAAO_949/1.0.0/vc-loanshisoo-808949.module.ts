...
import { VcLoanshisoo808949Component } from './vc-loanshisoo-808949.component';


@NgModule({
  declarations: [
    VcLoanshisoo808949Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanshisoo808949Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanshisoo808949Component],
  providers: [
    {
...
export class VcLoanshisoo808949Module { }