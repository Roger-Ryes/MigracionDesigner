...
import { VcLoanschile317288Component } from './vc-loanschile-317288.component';


@NgModule({
  declarations: [
    VcLoanschile317288Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoanschile317288Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoanschile317288Component],
  providers: [
    {
...
export class VcLoanschile317288Module { }