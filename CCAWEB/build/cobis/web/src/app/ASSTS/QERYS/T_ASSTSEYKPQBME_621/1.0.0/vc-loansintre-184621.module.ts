...
import { VcLoansintre184621Component } from './vc-loansintre-184621.component';


@NgModule({
  declarations: [
    VcLoansintre184621Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansintre184621Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansintre184621Component],
  providers: [
    {
...
export class VcLoansintre184621Module { }