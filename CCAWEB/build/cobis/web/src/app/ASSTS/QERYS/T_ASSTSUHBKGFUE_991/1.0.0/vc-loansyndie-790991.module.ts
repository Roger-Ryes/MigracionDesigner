...
import { VcLoansyndie790991Component } from './vc-loansyndie-790991.component';


@NgModule({
  declarations: [
    VcLoansyndie790991Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansyndie790991Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansyndie790991Component],
  providers: [
    {
...
export class VcLoansyndie790991Module { }