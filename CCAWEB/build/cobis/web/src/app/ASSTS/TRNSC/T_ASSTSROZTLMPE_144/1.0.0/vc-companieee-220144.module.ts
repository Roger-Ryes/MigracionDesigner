...
import { VcCompanieee220144Component } from './vc-companieee-220144.component';


@NgModule({
  declarations: [
    VcCompanieee220144Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcCompanieee220144Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcCompanieee220144Component],
  providers: [
    {
...
export class VcCompanieee220144Module { }