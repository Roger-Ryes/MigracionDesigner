...
import { VcPaymentmde245368Component } from './vc-paymentmde-245368.component';


@NgModule({
  declarations: [
    VcPaymentmde245368Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcPaymentmde245368Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcPaymentmde245368Component],
  providers: [
    {
...
export class VcPaymentmde245368Module { }