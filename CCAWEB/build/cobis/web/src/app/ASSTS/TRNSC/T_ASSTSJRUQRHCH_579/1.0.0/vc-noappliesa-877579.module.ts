...
import { VcNoappliesa877579Component } from './vc-noappliesa-877579.component';


@NgModule({
  declarations: [
    VcNoappliesa877579Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcNoappliesa877579Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcNoappliesa877579Component],
  providers: [
    {
...
export class VcNoappliesa877579Module { }