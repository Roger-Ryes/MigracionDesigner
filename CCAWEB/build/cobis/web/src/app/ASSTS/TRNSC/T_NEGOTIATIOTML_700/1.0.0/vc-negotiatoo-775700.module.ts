...
import { VcNegotiatoo775700Component } from './vc-negotiatoo-775700.component';


@NgModule({
  declarations: [
    VcNegotiatoo775700Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcNegotiatoo775700Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcNegotiatoo775700Component],
  providers: [
    {
...
export class VcNegotiatoo775700Module { }