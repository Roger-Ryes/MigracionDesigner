...
import { VcCompanieta879161Component } from './vc-companieta-879161.component';


@NgModule({
  declarations: [
    VcCompanieta879161Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcCompanieta879161Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcCompanieta879161Component],
  providers: [
    {
...
export class VcCompanieta879161Module { }