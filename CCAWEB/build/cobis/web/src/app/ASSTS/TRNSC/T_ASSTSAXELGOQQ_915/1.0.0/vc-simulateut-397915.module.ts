...
import { VcSimulateut397915Component } from './vc-simulateut-397915.component';


@NgModule({
  declarations: [
    VcSimulateut397915Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcSimulateut397915Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcSimulateut397915Component],
  providers: [
    {
...
export class VcSimulateut397915Module { }