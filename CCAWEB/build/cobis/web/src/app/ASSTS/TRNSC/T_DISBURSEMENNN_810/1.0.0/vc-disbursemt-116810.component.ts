...
import { Model } from './model/vc-disbursemt-116810.model';
import { ViewState } from './model/vc-disbursemt-116810-view-state';
import { VcDisbursemt116810Custom } from './vc-disbursemt-116810.custom';
import { ASSTSService} from 'src/app/ASSTS/service-modules/ASSTS.service';
@Component({
selector: 'cobis-vc-disbursemt-116810',
templateUrl: './vc-disbursemt-116810.component.html'
})
export class VcDisbursemt116810Component extends CobisDesignerComponent implements OnInit, AfterViewInit, AfterContentChecked {
constructor(
...
super(new VcDisbursemt116810Custom(designer.cobisCommons,assts), designer,breadcrumbService, formBuilder, translate, renderer, activatedRoute);
}
ngOnInit(): void {
this.inicializar();
super.ngOnInit();
...
let formGroupArray = {
LoanAdditionalInformation: viewState.T_DISBURSEMENNN_810.controls.LoanAdditionalInformation as FormGroup ,
DetailAmountsToCancel: viewState.T_DISBURSEMENNN_810.controls.DetailAmountsToCancel as FormGroup ,
DetailPaymentForm: viewState.T_DISBURSEMENNN_810.controls.DetailPaymentForm as FormGroup ,
LiquidateResult: viewState.T_DISBURSEMENNN_810.controls.LiquidateResult as FormGroup ,
DisbursementResult: viewState.T_DISBURSEMENNN_810.controls.DisbursementResult as FormGroup
};
this.metaData = { moduleId: 'ASSTS', subModuleId: 'TRNSC', taskId: 'T_DISBURSEMENNN_810', taskVersion: '1.0.0', vcId: 'VC_DISBURSEMT_116810', serverEvents: true, pageInfoEvents: new CobisModelPageInfoEvents(true, true), urlRestService: this.designer.cobisCommons.environment.values.dsgUrlRestService + '/ASSTS/TRNSC/T_DISBURSEMENNN_810', model: new Model(formGroupArray), viewState: viewState, loadCatalogsInfo: new Map<string, ICobisLoadCatalogInfo>([ ]), catalogsCobisInfo: new Map<string, ICobisCatalogCobisInfo>([ ['VA_CURRENCYOPUEQVI_819405', { catalogName: 'cl_moneda', filter: "", cobisRequestServerConfig: null, cache: 0 }], ]), queriesInfo: new Map<string, ICobisQueryInfo>([ ['QV_1603_21320', { queryId: 'Q_DETAILTM_1603', entityName: 'DetailAmountsToCancel', filter: "", cobisRequestServerConfig: null, cache: 0, queryMemberParameters:[ ]}], ['QV_5973_48889', { queryId: 'Q_DETAILAP_5973', entityName: 'DetailPaymentForm', filter: "", cobisRequestServerConfig: { pageSize :5 }, cache: 0, queryMemberParameters:[ ]}], ]), listsValues: new Map<string, ICobisListValuesInfo>([ ]) , label: 'Disbursement' }; this.breadcrumbService.getRoutes(this.metaData);
