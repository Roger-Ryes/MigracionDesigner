...
import { VcRefinancsl902781Component } from './vc-refinancsl-902781.component';


@NgModule({
  declarations: [
    VcRefinancsl902781Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRefinancsl902781Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRefinancsl902781Component],
  providers: [
    {
...
export class VcRefinancsl902781Module { }