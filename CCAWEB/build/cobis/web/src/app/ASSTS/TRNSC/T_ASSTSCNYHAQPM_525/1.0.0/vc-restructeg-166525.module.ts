...
import { VcRestructeg166525Component } from './vc-restructeg-166525.component';


@NgModule({
  declarations: [
    VcRestructeg166525Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcRestructeg166525Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcRestructeg166525Component],
  providers: [
    {
...
export class VcRestructeg166525Module { }