...
import { VcValuedaten586689Component } from './vc-valuedaten-586689.component';


@NgModule({
  declarations: [
    VcValuedaten586689Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcValuedaten586689Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcValuedaten586689Component],
  providers: [
    {
...
export class VcValuedaten586689Module { }