...
import { VcCompanycee242845Component } from './vc-companycee-242845.component';


@NgModule({
  declarations: [
    VcCompanycee242845Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcCompanycee242845Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcCompanycee242845Component],
  providers: [
    {
...
export class VcCompanycee242845Module { }