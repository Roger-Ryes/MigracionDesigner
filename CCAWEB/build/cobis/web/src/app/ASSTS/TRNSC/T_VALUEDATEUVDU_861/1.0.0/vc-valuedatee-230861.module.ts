...
import { VcValuedatee230861Component } from './vc-valuedatee-230861.component';


@NgModule({
  declarations: [
    VcValuedatee230861Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcValuedatee230861Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcValuedatee230861Component],
  providers: [
    {
...
export class VcValuedatee230861Module { }