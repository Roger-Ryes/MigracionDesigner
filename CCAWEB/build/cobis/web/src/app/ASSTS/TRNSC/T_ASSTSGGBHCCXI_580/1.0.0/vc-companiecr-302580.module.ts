...
import { VcCompaniecr302580Component } from './vc-companiecr-302580.component';


@NgModule({
  declarations: [
    VcCompaniecr302580Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcCompaniecr302580Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcCompaniecr302580Component],
  providers: [
    {
...
export class VcCompaniecr302580Module { }