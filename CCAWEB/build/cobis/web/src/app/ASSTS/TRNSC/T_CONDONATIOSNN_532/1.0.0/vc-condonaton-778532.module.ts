...
import { VcCondonaton778532Component } from './vc-condonaton-778532.component';


@NgModule({
  declarations: [
    VcCondonaton778532Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcCondonaton778532Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcCondonaton778532Component],
  providers: [
    {
...
export class VcCondonaton778532Module { }