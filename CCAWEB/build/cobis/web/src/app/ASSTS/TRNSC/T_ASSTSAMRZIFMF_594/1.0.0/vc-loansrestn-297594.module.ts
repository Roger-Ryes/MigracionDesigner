...
import { VcLoansrestn297594Component } from './vc-loansrestn-297594.component';


@NgModule({
  declarations: [
    VcLoansrestn297594Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcLoansrestn297594Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcLoansrestn297594Component],
  providers: [
    {
...
export class VcLoansrestn297594Module { }